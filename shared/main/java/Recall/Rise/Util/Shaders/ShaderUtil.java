package Recall.Rise.Util.Shaders;
...
public class ShaderUtil{
    ...
    public static String getShaderResource(final String resource) {
        try {
            final InputStream inputStream = RESOURCE_MANAGER.getResource(new ResourceLocation("liquidbounce/shader/fragment/" + resource)).getInputStream();
