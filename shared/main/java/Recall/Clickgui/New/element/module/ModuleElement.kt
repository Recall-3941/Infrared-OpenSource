package Recall.Clickgui.New.element.module

import net.ccbluex.liquidbounce.LiquidBounce
import net.ccbluex.liquidbounce.utils.render.BlendUtils
import net.ccbluex.liquidbounce.features.module.Module
import Recall.Clickgui.New.ColorManager
import Recall.Clickgui.New.element.components.ToggleSwitch
import Recall.Clickgui.New.element.module.value.ValueElement
import Recall.Clickgui.New.element.module.value.impl.BooleanElement
import Recall.Clickgui.New.element.module.value.impl.FloatElement
import Recall.Clickgui.New.element.module.value.impl.IntElement
import Recall.Clickgui.New.element.module.value.impl.ListElement
import Recall.Clickgui.New.extensions.animSmooth
...
class ModuleElement(val module: Module): MinecraftInstance() {
    ...
    companion object {
        protected val expandIcon = LiquidBounce.wrapper.classProvider.createResourceLocation("loserline/expand.png") }
    ...
    fun drawElement(mouseX: Int, mouseY: Int, x: Float, y: Float, width: Float, height: Float, accentColor: Color): Float {
        ...
        if (MouseUtils.mouseWithinBounds(mouseX, mouseY, 
                ...
                x + 35F + Fonts.font40.getStringWidth(module.name) + Fonts.font30.getStringWidth(keyName),
                y + height / 2F))
        ...
        Fonts.font30.drawString(keyName, x + 30.5F + Fonts.font40.getStringWidth(module.name), y + height / 2F - Fonts.font40.fontHeight + 5.5F, -1)
