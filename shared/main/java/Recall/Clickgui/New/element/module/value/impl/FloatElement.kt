...
import Recall.Clickgui.New.element.components.Slider
...
class FloatElement(val savedValue: FloatValue): ValueElement<Float>(savedValue) {
    ...
    override fun drawElement(mouseX: Int, mouseY: Int, x: Float, y: Float, width: Float, bgColor: Color, accentColor: Color): Float {
        ...
        Fonts.font40.drawString(value.name, x + 10F, y + 10F - Fonts.font40.fontHeight / 2F + 2F, -1)
        Fonts.font40.drawString("${savedValue.maximum}", 
                                x + width - 10F - maxLength - valueDisplay, 
                                y + 10F - Fonts.font40.fontHeight / 2F + 2F, -1)
        ...
        Fonts.font40.drawString("${round(savedValue.get())}", x + width + 6F - valueDisplay, y + 10F - Fonts.font40.fontHeight / 2F + 2F, -1)
        Fonts.font40.drawString("-", x + width - 3F - valueDisplay, y + 10F - Fonts.font40.fontHeight / 2F + 2F, -1)
        Fonts.font40.drawString("+", x + width - 17F, y + 10F - Fonts.font40.fontHeight / 2F + 2F, -1)
