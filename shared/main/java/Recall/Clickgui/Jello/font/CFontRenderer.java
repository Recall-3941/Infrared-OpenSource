...
extends CFont {
    ...
    public float BlurDrawString(String text,float x,float y,float x2, float y2) throws NoSuchFieldException, IllegalAccessException {
        return this.drawString(text, (float)(x - (float)(this.getStringWidth(text) / 2)), (float)y, -1);
    }
