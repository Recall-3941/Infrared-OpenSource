...
import Recall.Utils.normal.Utils;
...
public class DrRenderUtils implements Utils {
    ...
    public static void drawGradientRect(double left, double top, double right, double bottom, int startColor, int endColor) {
        ...
        worldrenderer.begin(7,classProvider.getVertexFormatEnum(WDefaultVertexFormats.POSITION_COLOR));
    ...
    public static void drawGoodCircle(double x, double y, float radius, int color) {
        ...
        GLUtil.setup2DRendering(() -> {
            ...
            glPointSize(radius * (2 * mc2.gameSettings.guiScale));
