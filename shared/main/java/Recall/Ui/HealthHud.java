...
public class HealthHud extends Element {
   ...
   // Double renderY;
    ...
    public Border drawElement() {
        ...
        final double newWidth = 51 * hpPercentage;
        ...
        Fonts.SFBOLD.SFBOLD_16.SFBOLD_16.drawCenteredString("HP", x + 20, y + 14 - 10, -1);
        ...
        double scoef = (mc2.player.getHealth() / mc2.player.getMaxHealth()) * 100.0f;
