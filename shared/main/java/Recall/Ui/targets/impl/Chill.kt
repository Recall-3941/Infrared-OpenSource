...
import Recall.Ui.targets.utils.CharRenderer
import net.ccbluex.liquidbounce.api.minecraft.client.entity.IEntityLivingBase
import net.ccbluex.liquidbounce.api.minecraft.client.entity.player.IEntityPlayer
import net.ccbluex.liquidbounce.ui.client.hud.element.Border
import net.ccbluex.liquidbounce.ui.font.Fonts
import net.ccbluex.liquidbounce.utils.Skid.HanaBiSkid.Color
...
import net.ccbluex.liquidbounce.utils.Skid.HanaBiSkid.*

class Chill(inst: LBplusTarget): TargetStyle("Chill", inst, true) {
    ...
    override fun drawTarget(entity: IEntityLivingBase) {
        ...
        // health bar
        RenderUtils.drawRoundedRect(4F, 38F, tWidth - 4F, 44F, 3, targetInstance.barColor.darker().rgb)
