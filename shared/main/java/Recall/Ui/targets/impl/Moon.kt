...
class Moon(inst: LBplusTarget): TargetStyle("Moon", inst, true) {
    ...
    override fun drawTarget(entity: IEntityLivingBase) {
        ...
        RenderUtils.drawRect(53F, 41f, 155.5F, 48.5F, getColor(Color.darkGray.darker().darker()).rgb)
        RenderUtils.drawRect(53F, 41f, 17.5F + (easingHealth / entity.maxHealth).coerceIn(0F, 1F) * 138F, 48.5F, targetInstance.barColor.rgb)
