...
public class ESPUtil{
    ...
    public static double[] getInterpolatedPos(Entity entity) {
        ...
        return new double[]{
                MathUtils.interpolate(entity.lastTickPosX, entity.posX, ticks) -Minecraft.getMinecraft().getRenderManager().viewerPosX,
                MathUtils.interpolate(entity.lastTickPosY, entity.posY, ticks) - Minecraft.getMinecraft().getRenderManager().viewerPosY,
                MathUtils.interpolate(entity.lastTickPosZ, entity.posZ, ticks) -Minecraft.getMinecraft().getRenderManager().viewerPosZ
        };
    }
