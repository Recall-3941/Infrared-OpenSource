...
import net.ccbluex.liquidbounce.utils.render.ShaderGroup
...
object BlurUtils {
    ...
    private val shaderGroup = ShaderGroup(mc2.textureManager, Minecraft.getMinecraft().resourceManager, Minecraft.getMinecraft().getFramebuffer(), ResourceLocation("shaders/post/blurarea.json"))
