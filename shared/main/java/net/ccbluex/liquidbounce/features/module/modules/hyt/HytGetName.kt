...
@ModuleInfo(name = "HytGetName", description = "fix by Last", category = ModuleCategory.HYT)
                ...
                "4v4/1v1", "32/64" -> {
                    ...
                    if (matcher.find()) {
                        ...
                        if (name != "") {
                            ...
                            ClientUtils.displayChatMessage("§8[§c§lInfrared提醒您§8]§c§d添加无敌人：" + name)
                            Thread {
                                try {
                                    Thread.sleep(5000)
                                    LiquidBounce.fileManager.friendsConfig.removeFriend(name)
                                    ClientUtils.displayChatMessage("§8[§c§lInfrared提醒您§8]§c§d删除无敌人：" + name)
