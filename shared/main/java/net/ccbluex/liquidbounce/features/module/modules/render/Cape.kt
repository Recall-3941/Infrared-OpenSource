...
class Cape : Module() {
    ...
    val styleValue = ListValue("Style", arrayOf("Dark", "Astolfo", "Astolfo2" ,"Sunny", "Staff" ,"Target", "Wyy", "PowerX", "Azrael", "Flux", "LiquidBounce", "Light", "Novoline", "YuZhiWen" ,"Special1", "Special2"), "Dark")
