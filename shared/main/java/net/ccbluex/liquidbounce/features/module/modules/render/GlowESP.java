...
import last.DecelerateAnimation;
...
public class GlowESP extends Module {
    ...
    public void createFrameBuffers() {
        framebuffer = me.aquavit.liquidsense.utils.RenderUtils.createFrameBuffer(framebuffer);
        outlineFrameBuffer = me.aquavit.liquidsense.utils.RenderUtils.createFrameBuffer(outlineFrameBuffer);
        glowFrameBuffer = me.aquavit.liquidsense.utils.RenderUtils.createFrameBuffer(glowFrameBuffer);
    }
    ...
    public void setupGlowUniforms(float dir1, float dir2) {
        ...
        glowShader.setUniformf("texelSize", 1.0f / mc2.displayWidth, 1.0f / mc2.displayHeight);
    ...
    public void setupOutlineUniforms(float dir1, float dir2) {
        ...
        outlineShader.setUniformf("texelSize", 1.0f / mc2.displayWidth, 1.0f / mc2.displayHeight);
    ...
    public void renderEntities(float ticks) {
        entities.forEach(entity -> {
            ...
            mc2.getRenderManager().renderEntityStatic(entity, ticks, false);
            renderNameTags = true;
        });
    }
    ...
    private Color getColor() {
        ...
        if (hudMod.getMovingcolors().get()) {
            ...
            return ColorUtil.interpolateColorsBackAndForth(15, 0, colors[0], colors[1],hudMod.getHueInterpolation().get());
        }
    }

    public void collectEntities() {
        entities.clear();
        for (Entity entity : mc2.world.getLoadedEntityList()) {
            if (!ESPUtil.isInView(entity)) continue;
            if (entity == mc2.player && mc2.gameSettings.thirdPersonView == 0) continue;
