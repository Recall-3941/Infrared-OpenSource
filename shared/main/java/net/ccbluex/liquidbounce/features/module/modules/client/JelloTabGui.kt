...
import net.ccbluex.liquidbounce.features.module.modules.client.utils.render.BlurUtils
import net.ccbluex.liquidbounce.features.module.modules.client.utils.render.ColorUtils1
import net.ccbluex.liquidbounce.features.module.modules.client.utils.render.Translate
...
class JelloTabGui : Module() {
    ...
    fun onTick(event: TickEvent) {
        ...
        val top = ColorUtils1.blend(ColorUtils1.colorFromInt(colorTop), ColorUtils1.colorFromInt(colorTopRight))
        val bottom = ColorUtils1.blend(ColorUtils1.colorFromInt(colorBottom), ColorUtils1.colorFromInt(colorBottomRight))
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        if(msTimer.hasTimePassed(50)) {
            ...
            if (mc.currentScreen !is GuiGameOver && mc2.gameSettings.guiScale == 2) {
    ...
    fun rendertabGui(evnet: Render2DEvent) {
        ...
        selecteModule.forEachIndexed{index , module ->
            ...
            val font = if(module.state)
                Fonts.fontSFUI35 else Fonts.fontSFUI35
