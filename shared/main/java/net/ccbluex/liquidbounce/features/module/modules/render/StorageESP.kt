        ...
        try {
            ...
            for (tileEntity in mc.theWorld!!.loadedTileEntityList) {
                val color: Color = when {
                    chestValue.get() && classProvider.isTileEntityChest(tileEntity) -> Color(0, 66, 255)
                    enderChestValue.get() && classProvider.isTileEntityEnderChest(tileEntity) -> Color.MAGENTA
