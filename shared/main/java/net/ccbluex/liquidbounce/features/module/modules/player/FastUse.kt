...
class FastUse : Module() {
    ...
    private val modeValue = ListValue("Mode", arrayOf("Instant", "NCP", "AAC", "CustomDelay","Hyt","VulCan"), "NCP")
            ...
            when (modeValue.get().toLowerCase()) {
                ...
                "vulcan" ->{
                    ...
                    if(thePlayer.onGround) {
                        ...
                        mc.netHandler.addToSendQueue(classProvider.createCPacketPlayerPosition(mc.thePlayer!!.posX, mc.thePlayer!!.posY, mc.thePlayer!!.posZ, mc.thePlayer!!.onGround))
                    }
                }
