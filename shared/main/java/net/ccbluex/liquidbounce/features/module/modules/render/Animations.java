...
public class Animations extends Module {
    ...
    //在MixinEntityLivingBase调用
    public static final ListValue guiAnimations = new ListValue("Container-Animation", new String[]{"None", "Zoom", "VSlide", "HSlide", "HVSlide"}, "Zoom");
    public static final IntegerValue SpeedSwing = new IntegerValue("Swing-Speed", 4, 0, 20);


    public static final ListValue Sword = new ListValue("Sword", new String[]{"Old", "1.7", "WindMill", "Push", "Smooth","SigmaOld","BigGod","Jello","Poke"}, "1.7");
