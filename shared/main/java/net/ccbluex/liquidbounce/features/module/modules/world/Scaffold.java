...
public class Scaffold extends Module {
    ...
    public void onRender2D(final Render2DEvent event) {
        if (counterDisplayValue.get()) {
            ...
            //GL11.glPopMatrix();
            RenderUtils.drawRoundedRect(scaledResolution.getScaledWidth() / 2 - (infoWidth / 2) - 4, scaledResolution.getScaledHeight() - 60, scaledResolution.getScaledWidth() / 2 + (infoWidth / 2) + 4, scaledResolution.getScaledHeight() - 74, 2F, new Color(0.15F, 0.15F, 0.15F).getRGB());
    ...
    public void getBestBlocks(){
        ...
        if(picker.get()){
            ...
            if (invCheck()) {
                ...
                IItemStack is = (IItemStack) functions.getItemById(261);
                for (int i = 9; i < 36; i++) {
