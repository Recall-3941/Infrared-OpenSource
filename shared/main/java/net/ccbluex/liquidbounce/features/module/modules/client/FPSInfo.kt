...
@ModuleInfo(name = "FPSInfo",description="sb", category = ModuleCategory.RENDER)
class FPSInfo : Module() {
    ...
    fun onRender(event: Render2DEvent){
        ...
        RoundedUtil.drawGradientRound(
                xValue.get() - 8.5f,
                yValue.get() - 2.0f,
                (Recall.Novoline.Font.Fonts.SFBOLD.SFBOLD_22.SFBOLD_22.stringWidth(mc.debugFPS.toString()+" FPS") + 17 ).toDouble().toFloat(), Recall.Novoline.Font.Fonts.SFBOLD.SFBOLD_22.SFBOLD_22.height+5F,
                4f,
