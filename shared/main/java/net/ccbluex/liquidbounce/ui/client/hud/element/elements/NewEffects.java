...
public class NewEffects extends Element {
    ...
    public Border drawElement() {
        ...
        for (final IPotionEffect potionEffect : mc.getThePlayer().getActivePotionEffects()) {
            ...
            Fonts.Sfui35.drawString(name + " " + intToRomanByGreedy(potionEffect.getAmplifier() + 1), 29F, posY - mc.getFontRendererObj().getFontHeight(), ClientUtils.reAlpha(HanaBiColors.WHITE.c, 0.8F));
