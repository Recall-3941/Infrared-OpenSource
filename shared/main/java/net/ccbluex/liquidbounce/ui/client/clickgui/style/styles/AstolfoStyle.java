...
public class AstolfoStyle extends Style {
    ...
    private Color getCategoryColor(String categoryName) {
        ...
        if (categoryName.equals("client")) {
            return new Color(15, 41, 212, 175);
        }
        if (categoryName.equals("hyt")) {
            return new Color(93, 231, 84, 175);
        }
        if (categoryName.equals("exploit")) {
            return new Color(201, 8, 215, 175);
        }
    ...
    public void drawDescription(int mouseX, int mouseY, String text) {
        ...
        RenderUtils.drawRect(mouseX + 9, mouseY, mouseX + textWidth + 14, mouseY + Fonts.posterama35.getFontHeight() + 3, new Color(26, 26, 26).getRGB());
        GlStateManager.resetColor();
        Fonts.posterama35.drawString(text.toLowerCase(), mouseX + 12, mouseY + (Fonts.posterama35.getFontHeight() / 2), Integer.MAX_VALUE);
    }
    ...
    public void drawButtonElement(int mouseX, int mouseY, ButtonElement buttonElement) {
        ...
        GlStateManager.resetColor();
        Fonts.posterama35.drawString(buttonElement.getDisplayName().toLowerCase(), buttonElement.getX() + 3,
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        GlStateManager.resetColor();
        Fonts.posterama35.drawString(moduleElement.getDisplayName().toLowerCase(), moduleElement.getX() + 3,
                moduleElement.getY() + 7, Integer.MAX_VALUE, true);

        final List<Value<?>> moduleValues = moduleElement.getModule().getValues();

        if (!moduleValues.isEmpty()) {
            Fonts.posterama35.drawString("+", moduleElement.getX() + moduleElement.getWidth() - 8,
            ...
            if (moduleElement.isShowSettings()) {
                ...
                for (final Value value : moduleValues) {
                    ...
                    if (value instanceof BoolValue) {
                        ...
                        float textWidth = Fonts.posterama35.getStringWidth(text);
                        ...
                        GlStateManager.resetColor();
                        Fonts.posterama35.drawString(text.toLowerCase(), moduleElement.getX() + moduleElement.getWidth() + 6,
                        ...
                        RenderUtils.drawRect(moduleElement.getX() + moduleElement.getWidth() + 4, yPos + 2, moduleElement.getX() +
                                moduleElement.getWidth() + moduleElement.getSettingsWidth(), yPos + 14, new Color(26, 26, 26).getRGB());
                        GlStateManager.resetColor();
                        Fonts.posterama35.drawString("§c" + text.toLowerCase(), moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, 0xffffff);
                        Fonts.posterama35.drawString(listValue.openList ? "-" : "+", (int) (moduleElement.getX() + moduleElement.getWidth() +
                        ...
                        for (final String valueOfList : listValue.getValues()) {
                            ...
                            if (listValue.openList) {
                                ...
                                GlStateManager.resetColor();
                                Fonts.posterama35.drawString(">", moduleElement.getX() +
                                        moduleElement.getWidth() + 6, yPos + 4, Integer.MAX_VALUE);
                                Fonts.posterama35.drawString(valueOfList.toLowerCase(), moduleElement.getX() + moduleElement.getWidth() + 14,
                        ...
                        GlStateManager.resetColor();
                        Fonts.posterama35.drawString(text.toLowerCase(), moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, 0xffffff);
                        yPos += 22;
                        ...
                        assert Fonts.posterama35 != null;
                        Fonts.posterama35.drawString(displayString.toLowerCase(), moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, Color.WHITE.getRGB());
                        ...
                        RenderUtils.drawRect(moduleElement.getX() + moduleElement.getWidth() + 4, yPos + 2, moduleElement.getX() +
                                moduleElement.getWidth() + moduleElement.getSettingsWidth(), yPos + 14, new Color(26, 26, 26).getRGB());
                        GlStateManager.resetColor();
                        Fonts.posterama35.drawString(text, moduleElement.getX() + moduleElement.getWidth() + 6, yPos + 4, 0xffffff);
                        yPos += 12;
                    }
                }
