...
class WBlockPos(x: Int, y: Int, z: Int) : WVec3i(x, y, z) {
    ...
    fun add(p_add_1_: WVec3i): WBlockPos {
        return if (p_add_1_.x === 0 && p_add_1_.y === 0 && p_add_1_.z === 0) this else WBlockPos(this.x + p_add_1_.x, this.y + p_add_1_.y, this.z + p_add_1_.z)
    }
