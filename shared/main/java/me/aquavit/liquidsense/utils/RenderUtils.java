...
public final class RenderUtils extends MinecraftInstance {
    ...
    public static Color interpolateColorsBackAndForth(int speed, int index, Color start, Color end, boolean trueColor) {
        ...
        return trueColor ? RenderUtils.interpolateColorHue(start, end, angle / 360f) : RenderUtils.interpolateColorC(start, end, angle / 360f);
    }
    ...
    public static void drawTexturedRectWithCustomAlpha(float x, float y, float width, float height, String image, float alpha) {
        ...
        mc.getTextureManager().bindTexture2(new ResourceLocation("move/shadow/" + image + ".png"));
    ...
    public static void drawTexturedRect(int x, int y, int width, int height, String image, IScaledResolution sr) {
        ...
        mc.getTextureManager().bindTexture(classProvider.createResourceLocation("move/cool/potionrender/" + image + ".png"));
    ...
    public static void drawBlockOutlineBox(final WBlockPos blockPos, final Color color, final float lineWidth) {
    ...
    public static void drawItemBox(final IEntity entity, final Color color, final boolean outline) {
        final IRenderManager renderManager = mc.getRenderManager();
        final ITimer timer = mc.getTimer();
        ...
        final IAxisAlignedBB axisAlignedBB = classProvider.createAxisAlignedBB(
                entityBox.getMinX() - entity.getPosX() + x,
                entityBox.getMinY() - entity.getPosY() + y,
                entityBox.getMinZ() - entity.getPosZ() + z,
                entityBox.getMaxX() - entity.getPosX() + x,
                entityBox.getMaxY() - entity.getPosY() + y,
                entityBox.getMaxZ() - entity.getPosZ() + z
        );

        GL11.glPushMatrix();
        GL11.glTranslated(x, y, z);
        GL11.glRotated(-entity.getRotationYaw(), 0F, 1F, 0F);
        GL11.glTranslated(-x, -y, -z);
        if (outline) {
    ...
    public static void drawEntityBox(final IEntity entity, final Color color, final boolean outline) {
        ...
        final IAxisAlignedBB entityBox = entity.getEntityBoundingBox();
        final IAxisAlignedBB axisAlignedBB = classProvider.createAxisAlignedBB(
                entityBox.getMinX() - entity.getPosX() + x - 0.15D,
                entityBox.getMinY() - entity.getPosY() + y,
                entityBox.getMinZ() - entity.getPosZ() + z - 0.15D,
                entityBox.getMaxX() - entity.getPosX() + x + 0.15D,
                entityBox.getMaxY() - entity.getPosY() + y + 0.15D,
                entityBox.getMaxZ() - entity.getPosZ() + z + 0.15D
        );
    ...
    public static void drawPlatform(final IEntity entity, final Color color) {
        ...
        drawAxisAlignedBB(
                classProvider.createAxisAlignedBB(axisAlignedBB.getMinX() - 0.15d, axisAlignedBB.getMinY(), axisAlignedBB.getMinZ()  - 0.15d, axisAlignedBB.getMaxX() + 0.15d, axisAlignedBB.getMaxY() + 0.1, axisAlignedBB.getMaxZ() + 0.15d),
                color
        );
    }
    ...
    public static  void drawTexturedModalRect(int p_drawTexturedModalRect_1_, int p_drawTexturedModalRect_2_, int p_drawTexturedModalRect_3_, int p_drawTexturedModalRect_4_, int p_drawTexturedModalRect_5_, int p_drawTexturedModalRect_6_) {
        ...
        lvt_10_1_.pos((double)(p_drawTexturedModalRect_1_ + 0), (double)(p_drawTexturedModalRect_2_ + p_drawTexturedModalRect_6_), (double)zLevel).tex((double)((float)(p_drawTexturedModalRect_3_ + 0) * 0.00390625F), (double)((float)(p_drawTexturedModalRect_4_ + p_drawTexturedModalRect_6_) * 0.00390625F)).endVertex();
        lvt_10_1_.pos((double)(p_drawTexturedModalRect_1_ + p_drawTexturedModalRect_5_), (double)(p_drawTexturedModalRect_2_ + p_drawTexturedModalRect_6_), (double)zLevel).tex((double)((float)(p_drawTexturedModalRect_3_ + p_drawTexturedModalRect_5_) * 0.00390625F), (double)((float)(p_drawTexturedModalRect_4_ + p_drawTexturedModalRect_6_) * 0.00390625F)).endVertex();
        lvt_10_1_.pos((double)(p_drawTexturedModalRect_1_ + p_drawTexturedModalRect_5_), (double)(p_drawTexturedModalRect_2_ + 0), (double)zLevel).tex((double)((float)(p_drawTexturedModalRect_3_ + p_drawTexturedModalRect_5_) * 0.00390625F), (double)((float)(p_drawTexturedModalRect_4_ + 0) * 0.00390625F)).endVertex();
        lvt_10_1_.pos((double)(p_drawTexturedModalRect_1_ + 0), (double)(p_drawTexturedModalRect_2_ + 0), (double)zLevel).tex((double)((float)(p_drawTexturedModalRect_3_ + 0) * 0.00390625F), (double)((float)(p_drawTexturedModalRect_4_ + 0) * 0.00390625F)).endVertex();
        lvt_9_1_.draw();
    }
...
//        IAxisAlignedBB box = classProvider.createAxisAlignedBB(posX - (double)e.getWidth()/2f, posY, posZ - (double)e.getWidth()/2f, posX + (double)e.getWidth()/2f, posY + (double)e.getHeight() + 0.2F, posZ + (double)e.getWidth()/2f);
//        GL11.glPushMatrix();
//        GL11.glColor4d((double)0.75, (double)0.0, (double)0.0, (double)0.0);
//        double size = (classProvider.isEntityItem(e)) ? 0.15 : 0.375;
//        //double size = 0.375;
//        double boundindY = e.getEntityBoundingBox().getMaxY() - e.getEntityBoundingBox().getMinY()+0.1;
//        ESPUtils.drawBoundingBox(classProvider.createAxisAlignedBB(posX - size, (double)posY, posZ - size, posX + size, (double)(posY + boundindY), posZ + size));
//        ESPUtils.renderOne();//renderOne
