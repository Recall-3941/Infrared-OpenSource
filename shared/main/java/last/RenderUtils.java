...
public final class RenderUtils extends MinecraftInstance {
    ...
    public static void autoExhibition(double x, double y, double x1, double y1, double size) {
        rectangleBordered(x, y, x1 + size, y1 + size, 0.5, net.ccbluex.liquidbounce.utils.Colors.getColor(90), net.ccbluex.liquidbounce.utils.Colors.getColor(0));
        rectangleBordered(x + 1.0, y + 1.0, x1 + size - 1.0, y1 + size - 1.0, 1.0, net.ccbluex.liquidbounce.utils.Colors.getColor(90), net.ccbluex.liquidbounce.utils.Colors.getColor(61));
        rectangleBordered(x + 2.5, y + 2.5, x1 + size - 2.5, y1 + size - 2.5, 0.5, net.ccbluex.liquidbounce.utils.Colors.getColor(61), Colors.getColor(0));
    }
